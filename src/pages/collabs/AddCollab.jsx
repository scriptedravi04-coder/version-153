              ...
              <div className="md:col-span-7 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] p-4 rounded-xl">
                    ...
                    <span className="text-base font-black font-display text-[var(--text-primary)] mt-1 block">
                      {formatAmount(previewMetrics.views)}
                    </span>
                  </div>
                  ...
                  <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] p-4 rounded-xl">
                    ...
                    <span className="text-base font-black font-display text-[var(--text-primary)] mt-1 block">
                      {formatAmount(previewMetrics.likes)}
                    </span>
                  </div>
                  ...
                  <div className="bg-[var(--bg-elevated)] border border-[var(--border-default)] p-4 rounded-xl">
                    ...
                    <span className="text-base font-black font-display text-[var(--text-primary)] mt-1 block">
                      {formatAmount(previewMetrics.reach)}
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <button 
                    ...
                    className="disabled:opacity-60 disabled:cursor-not-allowed w-full bg-[var(--violet)] hover:bg-[var(--violet-hover)] text-white font-extrabold text-xs py-3.5 rounded-2xl transition-all shadow-md uppercase tracking-wider cursor-pointer"
                   disabled={anyBusy}>{isBusy("submit") && <ButtonSpinner className="mr-1.5" />}
